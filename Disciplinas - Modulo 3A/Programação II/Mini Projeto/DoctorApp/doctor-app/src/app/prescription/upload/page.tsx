...
export default function PrescriptionUpload() {
    ...
    useEffect(() => {
        ...
        fetch('http://127.0.0.1:3003/getAllPrescriptions/', {
    ...
    const uploadPrescription = async (id: any) => {
        try {
            ...
            const res = await fetch('http://127.0.0.1:3003/uploadPrescription/' + id, {
                method: 'POST',
                headers: {
    ...
    const showFile = async (id: any) => {
        try {
            ...
            const res = await fetch('http://127.0.0.1:3003/readPrescription/' + id, {
                method: 'GET',
                headers: {
                    'Content-Type': 'multipart/form-data',
                    'Authorization': sessionStorage.getItem("token") || ''
    ...
    const generatePrescription = async (id: any) => {
        try {
            ...
            const res = await fetch('http://127.0.0.1:3003/generatePrescription/' + id, {
                method: 'GET',
                headers: {
                    'Authorization': sessionStorage.getItem("token") || ''
                },
