...
export default function DoctorCreate() {
    ...
    const addDoctor = async (e: any) => {
        ...
        if (name != "" && 
            ...
            const add = await fetch('http://127.0.0.1:3003/createDoctor', {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            <Link className="font-medium text-blue-600 dark:text-blue-500 hover:underline ms-5" href="/home">Voltar</Link>
            <form className='w-full' onSubmit={addDoctor} style={{padding:'100px'}}>
