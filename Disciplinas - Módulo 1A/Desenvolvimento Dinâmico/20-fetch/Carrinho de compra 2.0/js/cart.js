...
function atualizarCarrinho(){
    ...
    carrinho.forEach((produto, index)=>{
        ...
        `<div id='produto ${index}' class='d-flex flex-row justify-content-between align-items-center pt-lg-12 pt-md-12 pt-2pb-3 border-botton mobile'>
            ...
            <div class= 'pl-md-3 pl-2'>
                ...
                <span class='px-md-3' id='quantidade${index}'>
                    ${produto.quantidade}
                </span>
