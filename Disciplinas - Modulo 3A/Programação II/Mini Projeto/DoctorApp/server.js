...
import db from './database/database.js' //Para fazer a conexão com o banco de dados é preciso importar o database.js, mesmo que não seja usado diretamente pelo módulo
